...
public class EngineHandle
{
	...
	// -------------------------------------------------------------------------------------------------------------------
	public void method401( int x, int y, int height, boolean realodCurrent )
	{
		garbageCollect();
		method409( x, y, height, true, true );
	}
	...
	// -------------------------------------------------------------------------------------------------------------------
	public void method409( int x, int y, int height, boolean flag, boolean loadSection )
		{
		//int l = (x + 24) / 48;
		//int i1 = (y + 24) / 48;

		//System.out.println("method409, l: " + l);
		//System.out.println("method409, i1: " + i1);
		
		if( loadSection )
		{
			loadSection( x - 1, y - 1, height, 0 );
			loadSection( x, y - 1, height, 1 );
			loadSection( x - 1, y, height, 2 );
			loadSection( x, y, height, 3 );
		}
		...
		aModelArrayArray580[height] = aModel.method182( 0, 0, 1536, 1536, 8, 64,
				338, true );
		for( int l2 = 0; l2 < 64; l2++ )
		{
			camera.addModel( aModelArrayArray580[height][l2] );
		}
		...
		aModelArrayArray598[height] = aModel.method182( 0, 0, 1536, 1536, 8, 64,
				169, true );
		for( int l9 = 0; l9 < 64; l9++ )
		{
			camera.addModel( aModelArrayArray598[height][l9] );
		}
		if( aModelArrayArray598[height][0] == null )
		{
	...
	public void loadSection( int sectionX, int sectionY, int height, int sector )
	{
		...
		try
		{
			...
			if( e == null )
			{
				System.out.println("Could not find section, loading default ocean");
