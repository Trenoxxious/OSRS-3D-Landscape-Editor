...
public class SelectSectorsFrame extends JDialog implements ActionListener
{
	...
	private void initializeComponents()
	{
		...
		oldValueX = String.valueOf( client.sectionX);
		txtX = new JSpinner();
		...
		oldValueY = String.valueOf( client.sectionY );
		txtY = new JSpinner();
				...
				else
				{
					...
					if( curH < client.getConfig().getMinHeight()
						...
						message = "Height value should be in limits from "
								...
								+ String.valueOf( client.getConfig()
										.getMaxHeight() );
					else if( curX <= 0 || curX > 255 )
						message = "X value should be in limits from 1 to 255";
					else if( curY <= 0 || curY > 255 )
						message = "Y value should be in limits from 1 to 255";
